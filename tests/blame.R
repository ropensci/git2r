...
stopifnot(identical(b@hunks[[1]]@final_commit_id, sha(commit.1)))
...
stopifnot(identical(b@hunks[[1]]@orig_commit_id, sha(commit.1)))
...
stopifnot(identical(b@hunks[[2]]@final_commit_id, sha(commit.2)))
...
stopifnot(identical(b@hunks[[2]]@orig_commit_id, sha(commit.2)))
