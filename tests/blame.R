...
stopifnot(identical(b@hunks[[1]]@final_commit_id, commit.1@hex))
...
stopifnot(identical(b@hunks[[1]]@orig_commit_id, commit.1@hex))
...
stopifnot(identical(b@hunks[[2]]@final_commit_id, commit.2@hex))
...
stopifnot(identical(b@hunks[[2]]@orig_commit_id, commit.2@hex))
