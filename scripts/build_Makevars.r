...
build_Makevars.win <- function() {
    ...
    cat("    -DWIN32 -D_WIN32_WINNT=0x0501 -D__USE_MINGW_ANSI_STDIO=1 -DGIT_WINHTTP -DGIT_ARCH_64\n", file=Makevars)
    cat("else\n", file = Makevars)
    cat("PKG_LIBS = -L./winhttp -lws2_32 -lwinhttp -lrpcrt4 -lole32 -lcrypt32\n", file = Makevars)
    cat("PKG_CFLAGS = -I. -Ilibgit2 -Ilibgit2/include -Ihttp-parser -Iwin32 -Iregex -Izlib \\\n", file=Makevars)
    cat("    -DWIN32 -D_WIN32_WINNT=0x0501 -D__USE_MINGW_ANSI_STDIO=1 -DGIT_WINHTTP -DGIT_ARCH_32\n", file=Makevars)
    cat("endif\n", file = Makevars)
    cat("\n", file = Makevars)
