...
static const R_CallMethodDef callMethods[] =
{
    ...
    {"git2r_branch_create", (DL_FUNC)&git2r_branch_create, 5},
    ...
    {"git2r_checkout_commit", (DL_FUNC)&git2r_checkout_commit, 2},
    {"git2r_checkout_tag", (DL_FUNC)&git2r_checkout_tag, 2},
    {"git2r_checkout_tree", (DL_FUNC)&git2r_checkout_tree, 2},
