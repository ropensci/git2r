...
static const R_CallMethodDef callMethods[] =
{
    ...
    {"git2r_checkout_path", (DL_FUNC)&git2r_checkout_path, 2},
    ...
    {"git2r_config_get_logical", (DL_FUNC)&git2r_config_get_logical, 2},
    ...
    {"git2r_repository_discover", (DL_FUNC)&git2r_repository_discover, 2},
    ...
    {"git2r_ssl_cert_locations", (DL_FUNC)&git2r_ssl_cert_locations, 2},
